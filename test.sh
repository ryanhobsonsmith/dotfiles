...
command -v fd && echo "OK: fd installed"
command -v fzf && echo "OK: fzf installed"
command -v rg && echo "OK: ripgrep installed"
command -v delta && echo "OK: delta installed"
command -v jq && echo "OK: jq installed"
command -v tmux && echo "OK: tmux installed"
command -v zellij && echo "OK: zellij installed"
